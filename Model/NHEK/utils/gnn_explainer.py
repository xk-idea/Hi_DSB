...
class GNNExplainer(torch.nn.Module):
    ...
    def __init__(self, model, premod, epochs: int = 100, lr: float = 0.01,
    ...
    def explain_node(self, node_idx, x, edge_index, **kwargs):
        ...
        with torch.no_grad():
            log_logits, _ = self.model.embed(x=x, edge_index=edge_index, **kwargs)
            log_logits = self.premod(log_logits)
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            log_logits, _ = self.model.embed(x=h, edge_index=edge_index, **kwargs)
            log_logits = self.premod(log_logits)
